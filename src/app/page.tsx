        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 text-center">
          ...
          >
            ...
            <p className="text-lg mb-12 text-purple-200 max-w-2xl mx-auto">
              Discover luxury properties across Dubai. From modern villas in Emirates Hills to skyline apartments in Dubai Marina, 
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8">
              With years of expertise in the Dubai real estate market, we provide personalized service 
              to help you find the perfect property. Our commitment to excellence and deep local knowledge 
              makes us your trusted partner in Dubai real estate.
            </p>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl mb-4">🏆</div>
                <h3 className="text-xl font-semibold mb-2">Dubai Expert Guidance</h3>
                <p className="text-gray-600">Professional advice from Dubai real estate specialists</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">🌟</div>
                <h3 className="text-xl font-semibold mb-2">Premium Dubai Properties</h3>
                <p className="text-gray-600">Carefully curated selection of high-quality Dubai properties</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">🤝</div>
                <h3 className="text-xl font-semibold mb-2">Personalized Service</h3>
                <p className="text-gray-600">Dedicated support throughout your Dubai property journey</p>
              </div>
            </div>
      ...
      <footer className="bg-purple-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4">Dubai Property Types</h4>
              <ul className="text-purple-200 space-y-2">
                <li>Dubai Marina Apartments</li>
                <li>Emirates Hills Villas</li>
                <li>JBR Waterfront Townhouses</li>
                <li>Downtown Dubai Investment Properties</li>
              </ul>
            </div>
          </div>
