              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <div className="space-y-4 text-gray-600">
                  <p>
                    ...
                    ample space for comfortable living in one of Dubai's most prestigious locations.
                  </p>
                  <p>
                    Spanning {property.area.toLocaleString()} square feet, this property features modern design elements, 
                    high-quality finishes, and premium amenities. Located in one of Dubai's most desirable 
                    neighborhoods, it offers easy access to shopping malls, fine dining, and world-class entertainment.
                  </p>
                  <p>
                    Perfect for families or investors looking for a premium property in Dubai, this 
                    {property.type.toLowerCase()} represents excellent value at {formatPrice(property.price)}. 
                    Experience luxury living in the heart of Dubai with stunning views and modern conveniences.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    "Spacious Living Areas with City Views", 
                    "Premium Marble Flooring Throughout",
                    "Central Air Conditioning System",
                    "High-Speed Internet and Smart Home Ready",
                    "24/7 Security and Concierge Service",
                    "Dedicated Parking Spaces",
                    "Close to Dubai Mall and Metro",
                    "Swimming Pool and Gym Access",
                    "Prime Dubai Location with Easy Access"
                  ].map((feature, index) => (
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <textarea
                    ...
                    defaultValue={`I'm interested in ${property.title} in ${property.city}. Please contact me with more details.`}
                  />
                  <button
